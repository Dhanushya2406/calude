...
var require_utils = __commonJS({
  "node_modules/sigma/utils/index.js"(exports) {
    ...
    function createElement(tag, style2, attributes) {
      var element = document.createElement(tag);
      if (style2) {
        for (var k in style2) {
          element.style[k] = style2[k];
        }
      }
      if (attributes) {
  ...
  "node_modules/sigma/core/labels.js"(exports) {
    ...
    var LabelCandidate = (
      ...
      function() {
        ...
        LabelCandidate2.compare = function(first2, second) {
          if (first2.size > second.size)
            return -1;
          if (first2.size < second.size)
            return 1;
          if (first2.key > second.key)
            return 1;
          return -1;
        };
...
var require_node_fast_vert_glsl = __commonJS({
  "node_modules/sigma/rendering/webgl/shaders/node.fast.vert.glsl.js"(exports, module) {
    (() => {
      "use strict";
      var o = { d: (t2, e2) => {
        for (var n in e2) o.o(e2, n) && !o.o(t2, n) && Object.defineProperty(t2, n, { enumerable: true, get: e2[n] });
...
var require_edge_frag_glsl = __commonJS({
  "node_modules/sigma/rendering/webgl/shaders/edge.frag.glsl.js"(exports, module) {
    (() => {
      "use strict";
      var e = { d: (n2, t2) => {
        for (var o in t2) e.o(t2, o) && !e.o(n2, o) && Object.defineProperty(n2, o, { enumerable: true, get: t2[o] });
      }, o: (e2, n2) => Object.prototype.hasOwnProperty.call(e2, n2), r: (e2) => {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e2, "__esModule", { value: true });
      } }, n = {};
...
var require_edge_arrowHead_vert_glsl = __commonJS({
  "node_modules/sigma/rendering/webgl/shaders/edge.arrowHead.vert.glsl.js"(exports, module) {
    (() => {
      "use strict";
      var a = { d: (e2, t2) => {
        for (var o in t2) a.o(t2, o) && !a.o(e2, o) && Object.defineProperty(e2, o, { enumerable: true, get: t2[o] });
...
var require_edge_clamped_vert_glsl = __commonJS({
  "node_modules/sigma/rendering/webgl/shaders/edge.clamped.vert.glsl.js"(exports, module) {
    (() => {
      "use strict";
      var e = { d: (o2, n2) => {
        for (var t in n2) e.o(n2, t) && !e.o(o2, t) && Object.defineProperty(o2, t, { enumerable: true, get: n2[t] });
      }, o: (e2, o2) => Object.prototype.hasOwnProperty.call(e2, o2), r: (e2) => {
        "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e2, "__esModule", { value: true });
      } }, o = {};
  ...
  "node_modules/sigma/sigma.js"(exports) {
    ...
    var Sigma2 = (
      ...
      function(_super) {
        ...
        Sigma3.prototype.unbindGraphHandlers = function() {
          var graph = this.graph;
        ...
        Sigma3.prototype.setGraph = function(graph) {
          if (graph === this.graph)
            return;
...
function isIgnorable(dom, dir) {
  let desc = dom.pmViewDesc;
  return desc ? desc.size == 0 && (dir < 0 || dom.nextSibling || dom.nodeName != "BR") : dom.nodeType == 1 && dom.contentEditable == "false";
}
...
editHandlers.compositionstart = editHandlers.compositionupdate = (view) => {
  if (!view.composing) {
    ...
    if (state.selection instanceof TextSelection && state.selection.empty && (state.storedMarks || !$pos.textOffset && $pos.parentOffset && $pos.nodeBefore.marks.some((m) => m.type.spec.inclusive === false) || chrome2 && windows && selectionBeforeUneditable(view))) {
...
var DOMObserver = class {
  ...
  flush() {
    ...
    if (added.some((n) => n.nodeName == "BR") && (view.input.lastKeyCode == 8 || view.input.lastKeyCode == 46 || chrome2 && (view.composing || view.input.compositionEndedAt > Date.now() - 50) && mutations.some((m) => m.type == "childList" && m.removedNodes.length))) {
...
function readDOMChange(view, from2, to, typeOver, addedNodes) {
  ...
  let mkTr = (base2) => {
    ...
    if (parse.sel) {
      ...
      if (sel2 && !(chrome2 && view.composing && sel2.empty && (change.start != change.endB || view.input.lastChromeDelete < Date.now() - 100) && (sel2.head == chFrom || sel2.head == tr.mapping.map(chTo) - 1) || ie && sel2.empty && sel2.head == chFrom))
...
async function tagItems({ query }) {
  const matches2 = await tagStore.queryTags(query);
  const norm = tagStore.normalizeTagName(query);
  const hasExact = matches2.some((t) => t.normalizedName === norm);
  const list = matches2.slice(0, 8);
...
async function mountKnowledgeView(root) {
  root.innerHTML = `
    <div class="kg-layout">
  ...
  async function showRelatedNotes(tagId) {
    ...
    document.getElementById("kgRelatedList").innerHTML = notes.map((n) => {
